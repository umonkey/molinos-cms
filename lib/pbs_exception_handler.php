...
function SendBlueScreen($content, $e)
{
    ...
    BebopMimeMail::send(null, $to, "ERROR at {$_SERVER['HTTP_HOST']}", $body, array(
        'name' => 'bluescreen.html',
        'data' => $content,
        'type' => 'text/hmtl',
        ));
...
<html lang="en">
    ...
    <body>
        <h1>Ошибка</h1>
        <p>При обработке запроса возникла фатальная ошибка, информация о&nbsp;которой отправлена в&nbsp;службу поддержки.&nbsp; Попробуйте повторить операцию позднее.</p>
    </body>
</html><?php
    } else {
        print $data;
