var tinyMCE_GZ = {
	...
	loadScripts : function(co, th, pl, la, cb, sc) {
		...
		// Correct a bug in Opera :
		// If the URL is exactly the same, the PHP file results are cached
		// (no cache is not considered)
		aleat='&idrnd='+ Math.random();
		
		x.open('GET', t.baseURL + '/' + s.page_name + '?' + q + aleat, !!cb);
