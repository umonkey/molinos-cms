...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="content" mode="content">
    ...
    <p>Помните, что здесь вы управляете только видимостью разделов, права на создание и публикацию документов разных типов <a href="admin/structure/types">настраиваются отдельно</a>.</p>
    <p>При добавлении подразделов копируются права родительского раздела.</p>
