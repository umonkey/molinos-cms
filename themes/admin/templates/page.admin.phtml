...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <div id="all">
      ...
      <div id='top_menu_controls'><?php print $dashboard; ?></div>
      ...
      <div id="navbar">
        <div id="top_toolbar">
          <div class="right">
            ...
            <a href="?q=base.rpc&amp;action=logout&amp;from=<?php print urlencode($_SERVER['REQUEST_URI']); ?>" id="lnk_exit" title="Выйти"><img src="themes/admin/img/icon-exit.png" alt="logout" width="16" height="16" /></a>
          </div>
        </div><!-- id=top_toolbar -->
    ...
    <div id="footer">
      <div class="signature">
        <hr/><?php print mcms::getSignature(null, true); ?>
      </div>
    </div>
    <?php endif; ?>
